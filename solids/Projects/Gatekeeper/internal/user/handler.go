...
func (h *UserHandler) CreateUser(c *gin.Context) {
	...
	if err != nil {
		...
		case ErrFirstNameRequired, ErrLastNameRequired, ErrEmailRequired, ErrInvalidEmailFormat,
			ErrUsernameRequired, ErrPasswordRequired, ErrPasswordTooShort, ErrPasswordInvalidCharacters:
			c.AbortWithStatusJSON(http.StatusBadRequest, gin.H{"message": err.Error()})
			return
		case ErrEmailAlreadyExists, ErrUserEmailAlreadyExists, ErrUserUsernameAlreadyExists:
